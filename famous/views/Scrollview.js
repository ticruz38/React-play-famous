...
define(function (require, exports, module) {
    ...
    function _bindEvents() {
        ...
        this._particle.on('update', function (particle) {
            ...
            this.outputFrom(this._displacement);
        }.bind(this));
    ...
    function _normalizeState() {
        ...
        while (offset + position >= nodeSize && nextNode) {
            ...
            console.log('sequence!!', this._scroller.sequenceFrom(nextNode), position);
        ...
        while (offset + position <= 0 && previousNode) {
            ...
            console.log('sequenceback!!', this._scroller.sequenceFrom(nextNode), position);
    ...
    Scrollview.prototype.outputFrom = function outputFrom(position) {
        //console.log(position);
        this._scroller.outputFrom.call(this._scroller, position);
    };
     ...
     */
    Scrollview.prototype.sequenceFrom = function sequenceFrom(originalNode) {
        if (originalNode instanceof Array) originalNode = new ViewSequence({
            array: originalNode,
            trackSize: true
        });
        this._node = originalNode;
        return this._scroller.sequenceFrom(originalNode);
