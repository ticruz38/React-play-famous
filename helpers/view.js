        ...
        var OptionsManager = require('../famous/core/OptionsManager.js'),
        ...
        function View(options) {
            ...
            this._element = options.element ? options.element : console.log('you need to define an element in options');
            _setChildElements.call(this, this.options);
